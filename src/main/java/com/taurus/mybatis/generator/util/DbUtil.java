package com.taurus.mybatis.generator.util;

import com.jcraft.jsch.JSch;
import com.jcraft.jsch.JSchException;
import com.jcraft.jsch.Session;
import com.taurus.mybatis.generator.exception.DbDriverLoadingException;
import com.taurus.mybatis.generator.model.DatabaseConfig;
import com.taurus.mybatis.generator.model.DbType;
import com.taurus.mybatis.generator.model.UITableColumnVO;
import com.taurus.mybatis.generator.view.AlertUtil;
...
public class DbUtil {
    ...
    private final static Map<DbType, Driver> drivers = new HashMap<>();

    private final static ExecutorService executorService = Executors.newSingleThreadExecutor();
    private static volatile boolean portForwaring = false;
    private final static Map<Integer, Session> portForwardingSession = new ConcurrentHashMap<>();
